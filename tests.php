	...
	<div class="col-sm-12 container-fluid" style="height: 577px; background-color: #FFFFFF;">
		...
		<div class="col-sm-10" style="background-color: #FFFFFF;height:577px;overflow-y: scroll;">
			...
			<table class="table table-striped" style="font-size: 20px;">
			    ...
			    <tbody>
		    	<?php
					$sql="SELECT * FROM tests WHERE NOT EXISTS (SELECT * FROM result WHERE tests.test_id=result.test_id AND result.user_id='$user_id')";
					...
					while($row=mysqli_fetch_array($result))
					{
			      	...
			      	<tr>
			        	...
			        	<td><button class="btn btn-primary" onclick="window.location.href='/capstone/listening.php?id=<?php echo $row["test_id"] ?>'">Attempt</button></td>
			      	</tr>
			      	<?php
					}
				?>
