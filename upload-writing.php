	...
	<form method="post" enctype="multipart/form-data">
		...
		<div class="col-sm-offset-1 upload-writing-background col-sm-10">
			...
			<div class="form-group col-sm-12" style="margin-top: 20px;">
   	 			...
   	 			<div class="col-sm-7">
   	 				<textarea style="height:100px;" class="form-control txtarea" name="writing_task_1"></textarea required>
   	 			</div>
  			</div>
  			...
  			<div class="form-group col-sm-12">
   	 			...
   	 			<div class="col-sm-7">
   	 				<textarea style="height:100px;" class="form-control txtarea" name="writing_task_2"></textarea required>
   	 			</div>
  			</div>
...
<?php
	if(isset($_POST['submit']))
    {
        ...
        {
        	$sql="insert into writing values ('$test_id','$question_1','$question_2','$image')";
			if(mysqli_query($conn,$sql))
			{
				?>
				<script >
					alert("Writing Module Added");
